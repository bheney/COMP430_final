# This file was modified to work with `pispi` SPI library and is a fork of
#   ... lib_nrf24.py is a slightly tweaked version of Barraca's "pynrf24".


#   Brian Lavery's Oct 2014 tweak for Raspberry Pi and "Virtual GPIO" ...
...
0
Looking
lib_nrf24/lib_nrf24.py at master · BLavery/lib_nrf24